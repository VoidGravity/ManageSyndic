...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/_sitemap` | `/components/Breadcrumb` | `/components/ButtonField` | `/components/CheckBoxInputField` | `/components/DrawerNavigation` | `/components/Header` | `/components/TextInputField` | `/screens/Auth/ForgotPasswordScreen` | `/screens/Auth/LoginScreen` | `/screens/Auth/ResetPasswordScreen` | `/screens/ContibutionScreen` | `/screens/DashboardScreen` | `/screens/ServicingScreen`;
