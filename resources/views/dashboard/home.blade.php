                                ...
                                <div class="py-4 px-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h2 class="mb-0"><span class="counter-value" data-target="{{ $residentialBuildings }}">{{ $residentialBuildings }}</span>
                                            </h2>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col">
                                <div class="mt-3 mt-md-0 py-4 px-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h2 class="mb-0"><span class="counter-value" data-target="{{ $residents }}">{{ $residents }}</span></h2>
                                        </div>
                                    </div>
                                </div>
                            </div><!-- end col -->
                            ...
                            <div class="col">
                                <div class="mt-3 mt-md-0 py-4 px-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h2 class="mb-0"><span class="counter-value" data-target="{{ $syndics }}">{{ $syndics }}</span></h2>
                                        </div>
                                    </div>
                                </div>
                            </div><!-- end col -->
                            ...
                            <div class="col">
                                <div class="mt-3 mt-lg-0 py-4 px-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h2 class="mb-0"><span class="counter-value" data-target="{{ $contributions }}">{{ $contributions }}</span>
                                            </h2>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col">
                                <div class="mt-3 mt-lg-0 py-4 px-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h2 class="mb-0"><span class="counter-value" data-target="{{ $servicings }}">{{ $servicings }}</span></h2>
                                        </div>
                                    </div>
                                </div>
                            </div><!-- end col -->
                ...
                <div class="card-body px-0">
                    <ul class="list-inline main-chart text-center mb-0">
                        <li class="list-inline-item chart-border-left me-0 border-0">
                            <h4 class="text-primary">{{ $contributionPriceTotal }} <span class="text-muted d-inline-block fs-13 align-middle ms-2 text-danger">Contribution</span></h4>
                        </li>
                        <li class="list-inline-item chart-border-left me-0">
                            <h4>{{ $servicingPriceTotal }}<span class="text-muted d-inline-block fs-13 align-middle ms-2">Servicing</span>
                            </h4>
                        </li>
                    </ul>
