...
<div class="row">
    <div class="col-xxl-12">
        <div class="card">
            ...
            <!-- end card header -->
            <div class="card-body">
                <form action="{{ route('dashboard.admin.resident.update', $resident) }}" method="POST">
                    @csrf
                    ...
                    <div class="row gy-4 mb-4">
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div>
                                ...
                                <select class="form-select mb-3" aria-label="Default select example" name="building" value="{{ old('building', $resident->building->id) }}">
