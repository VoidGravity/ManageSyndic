    ...
    <div class="col-xxl-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                ...
                <a href="{{ route('dashboard.admin.building.create') }}" class="btn btn-primary">Add new building</a>
            </div>
            <!-- end card header -->
            <div class="card-body">
