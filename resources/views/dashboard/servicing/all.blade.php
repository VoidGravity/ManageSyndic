            ...
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    ...
                    @if (in_array(Auth::user()->role, ['SYNDIC', 'ADMIN']))
                        <a href="{{ route('dashboard.servicing.create') }}" class="btn btn-primary">Add new servicing</a>
                    @endif
                </div>
                <!-- end card header -->
                <div class="card-body">
                    <div class="table-responsive table-card">
                        <table class="table dataTable table-borderless table-hover table-nowrap align-middle mb-0">
                                        ...
                                        <tr>
                                            ...
                                            @if (in_array(Auth::user()->role, ['SYNDIC', 'ADMIN']))
                                                <td class="d-flex">
                                                    ...
                                                    <a href="{{ route('dashboard.servicing.delete', $servicing) }}" class="text-body fw-medium mx-1">
