    ...
    <div class="col-xxl-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('dashboard.resident.save') }}" method="post">
                    @csrf
                    ...
                    <div class="row gy-4 mb-4">
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div>
                                ...
                                <select data-choices  class="form-select mb-3" aria-label="Default select example" name="building" value="{{ old('building') }}">
